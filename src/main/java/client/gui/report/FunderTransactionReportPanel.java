 ...
 * @author User
 */
public class FunderTransactionReportPanel extends JpanelTemplate
{
	...
	public FunderTransactionReportPanel(String title)
	{
		super();
	}

	public FunderTransactionReportPanel( )
	{
		this("Report");
	}
	...
	private void fillData( )
	{
		ProgressBar.execute(new ProgressBarListener<ContractBean>()
		{
			...
			public void onDone(ContractBean response)
			{
				...
				entries.addAll(response.getFunders());
	...
	protected void fillCrudTable(SearchBean searchBean )
	{
		...
		ProgressBar.execute(new ProgressBarListener<ReportTableModel>()
		{
			...
			public ReportTableModel onBackground( ) throws Exception
			{
				...
				return App.getCrudService().getFundersTransaction(searchBean);
			}
