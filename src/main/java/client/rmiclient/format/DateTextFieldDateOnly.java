 ...
 * @author foo
 */
public class DateTextFieldDateOnly extends JTextField{
    ...
    private DateTextFieldDateOnly focusto = null;
    private String focusInitValue = "ini";
    //public static final String DATEINIT = "dd-mm-yyyy";
    //                                    "yyyy-mm-dd HH:mm:ss"
    public static final String DATEINIT = "yyyy-mm-dd";
    ...
    public DateTextFieldDateOnly getFocusto() {
        return focusto;
    }

    public void setFocusto(DateTextFieldDateOnly focusto) {
        this.focusto = focusto;
        focusInitValue = getFirstDay();
    }

    public DateTextFieldDateOnly(){
        super();
    ...
    class MyDocument extends javax.swing.text.PlainDocument{
        ...
        public MyDocument(DateTextFieldDateOnly pcomp, DateTextFieldDateOnly pfocusto){
           // comp = pcomp;
            focusto = pfocusto;
        }
        ...
        public void insertString(int offset, String str, AttributeSet a) throws BadLocationException {
            String text = DateTextFieldDateOnly.super.getText();
            ...
            switch(offset){
                 case 0:
                    if(Character.isDigit(ch) ) {
                        ...
                        DateTextFieldDateOnly.this.setText(str);
                        DateTextFieldDateOnly.this.setCaretPosition(offset+1);
                    }
                    break;
                case 1:
                    if(Character.isDigit(ch) ) {
                ...
                case 3:
                    if(Character.isDigit(ch) ) {
                        ...
                        str = text.substring(0, offset)+ch + text.substring(offset+1);
                        DateTextFieldDateOnly.this.setText(str);
                        DateTextFieldDateOnly.this.setCaretPosition(offset+2);
//                        
                    }
                    break;
                case 4:
...
//                    break;
        ...
        public void remove(int offs, int len) throws BadLocationException {
            DateTextFieldDateOnly.this.setCaretPosition(offs);
        }
    ...
    class MyFocusListener implements FocusListener{
      //  JTextField comp = null;
        ...
        public void focusGained(FocusEvent e) {
            ...
            String ggg = DateTextFieldDateOnly.super.getText();
            if (ggg.equalsIgnoreCase(DATEINIT)||ggg.equalsIgnoreCase("")) {
                ...
                DateTextFieldDateOnly.this.setText("");
                DateTextFieldDateOnly.this.setText(focusInitValue);
                DateTextFieldDateOnly.this.setCaretPosition(0);
            }
        }
